...
class laporan extends CI_Controller{
	...
	function index(){
		$this->load->view('owner/laporan/data_jurnal_umum');
	}

	function menu_laporan(){
		$this->load->view('owner/laporan/menu_laporan');
	}
	...
	function data_jurnal_umum(){
		...
		$this->load->view('owner/laporan/data_jurnal_umum',$data);
	}
	...
	function data_buku_besar(){
		...
		$this->load->view('owner/laporan/data_buku_besar',$data);
	}
	...
	function data_neraca_saldo(){
		...
		$this->load->view('owner/laporan/data_neraca_saldo',$data);
	}
	...
	function data_laba_rugi(){
		...
		$this->load->view('owner/laporan/data_laba_rugi',$data);
	}
	...
	function data_perubahan_modal(){
		...
		$this->load->view('owner/laporan/data_perubahan_modal',$data);
	}
}
