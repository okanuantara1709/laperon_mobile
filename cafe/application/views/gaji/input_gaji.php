					...
					<div class="box-body">
						<form>						
							...
							<div class="form-group nik">
								...
								<input type="text" class="form-control" name="jabatan" value="<?php echo $karyawan['jabatan'] ?>" readonly>
							</div>		
							<div class="form-group nik">
								<label for="">Status</label>
								<input type="text" class="form-control" name="jabatan" value="<?php echo $karyawan['status'] ?>" readonly>
							</div>				
							<div class="filter-bln form-group no-pad">
								<label for="">Bulan</label>						
								<select class="form-control" name="bln">
								<?php $bln = array("Januari","Pebruari","Maret","April","Mei","Juni","Juli","Agustus","September","October","Nopember","Desember"); ?>
								<?php for($i=0;$i<12;$i++): ?>
