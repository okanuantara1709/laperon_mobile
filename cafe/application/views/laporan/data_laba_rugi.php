				...
				<div class="box-body">
					<table class="table table-bordered" width="100%">
						...
						<tbody>						
							...
							<?php
								$tot_hutang += $value['kredit'];
								endforeach;
							 ?>	
							 <tr>								
								<td><span class="total">Total hutang</span></td>
								<td></td>
								<td><u>Rp. <?php echo number_format($tot_hutang) ?></u></td>								
							</tr>	
							<tr>								
								<td><u>Beban :</u></td>
								<td></td>
							...
							<tr>								
								<td>Laba Bersih</td>
								<td></td>
								<td><u>Rp. <?php echo number_format($tot_pendapatan-$tot_hutang-$tot_beban)  ?></u></td>								
							</tr>							
						</tbody>
					</table>
				</div>
