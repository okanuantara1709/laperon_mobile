	...
	<section class="clearfix wrapper">
		...
		<div class="col-md-10 main-content">
			<div class="box box-info">
				...
				<form action="<?php echo base_url(). 'pegawai/karyawan/update_karyawan'; ?>" method="post">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="input-group date" data-provide="datepicker">
							    <input class="form-control date" name="tgl" type="text" value="<?php echo date('d/m/Y',strtotime($karyawan['tgl'])) ?>">
						...
						<div class="box-footer">
							...
							<a href="<?php echo base_url() ?>pegawai/karyawan/detail_karyawan" class="btn btn-default">Cancel</a>
						</div>
					</div>
				</form>				
