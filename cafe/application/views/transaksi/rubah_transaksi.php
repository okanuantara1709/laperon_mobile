	...
	<section class="clearfix wrapper">
		...
		<div class="col-md-10 main-content">
			<div class="box box-info">
				...
				<form action="<?php echo base_url(). 'transaksi/rubah_transaksi'; ?>" method="post">
					<div class="box-body">
						<div class="form-group">
							<div>
								<span class="no-transaksi">No. Transaksi : <?php echo $transaksi['id_transaksi'] ?></span>
							...
							<div class="input-group date tgl" data-provide="datepicker">
							    <input type="text" class="form-control date" name="tgl" value="<?php echo  $transaksi['tgl']; ?>">
						...
						<?php foreach ($dtl_transaksi as $key => $list) : ?>							
							<div class="transaksi_list">
								<div class="form-group input-transaksi">
									...
									<select name="code_akun[]" class="form-control selectbox" id="">									
										<?php foreach ($coa_list as $key => $value) {
											$select = '';
											if($list['code_akun'] == $value['code_akun'] ){
								...
								<div class="form-group input-transaksi">	
									...
									<input type="text" class="form-control debit_val" name="debit[]" value="<?php echo $list['debit'] ?>">
								</div>
								<div class="form-group input-transaksi">
									<label form="" class="">Kredit</label>									
									<input type="text" class="form-control kredit_val" name="kredit[]" value="<?php echo $list['kredit'] ?>">
								</div>								
							</div>
						<?php endforeach; ?>
