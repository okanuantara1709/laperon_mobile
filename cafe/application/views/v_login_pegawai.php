...
<body>
    <div class="col-md-12 panel ">
        ...
        <div class="panel-body" style="padding-top: 15px">
            <form action="<?php echo base_url() ?>pegawai/login/aksi_login" method="post">
	            ...
	            <div class="btn-login">
                    <input type="submit" class="btn btn login " style="background-color: #fff ;color: #49210B;" value="Login">
                    <?php 
                        if(!empty($_GET['error'])):
                     ?>
