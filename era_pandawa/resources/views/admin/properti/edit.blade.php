                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header">
                            <h3 class="box-title"><i class="{{$template->icon}}"></i> Form Ubah {{$template->title}}</h3>                            
                        </div>
                        <form action="{{route("$template->route".".update",[$data->id])}}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="box-body">  
    ...
    <script>
        var map, marker;
         function initMap(){
            ...
            var lat = @php echo $data->lat @endphp;
            var lng = @php echo $data->lng @endphp;
